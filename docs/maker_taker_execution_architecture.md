...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| **Hyperliquid** | **Maker-Taker (推荐)** | **0.0144%** (Alo) | **0.0432%** (Ioc) | **0.0576%** | **0.1152%** | **🔥 节省 47.8%** |
| Hyperliquid | Taker-Taker (全市价) | 0.0672% | 0.0432% | 0.1104% | 0.2208% | 基准 |
...
> - **Taker-Taker 进场**：需要 $\frac{0.1104\%}{0.00342\%} = \mathbf{32.3\text{ 小时}}$ 才能覆盖进场手续费。
> - **Maker-Taker 进场**：仅需 $\frac{0.0576\%}{0.00342\%} = \mathbf{16.8\text{ 小时}}$ 即可回本，**回本效率提升近一倍**！
